    ...
    case "fp002":
      if (cabo.value === "ramal barrigado") {
        ...
        break;
          ...
          result.value = `#${fp.value} ${moto.value} informa ${cabo.value} sem risco no momento necessário agendamento para poda`;
          break;  
        }
        else if (cabo.value === "capa do secundario") {
          result.value = `#${fp.value} ${moto.value} informa ${cabo.value} no alto sem risco no momento necessário equipe para remoção`;
          break;              
